...
// https://tiledimageservices.arcgis.com/jIL9msH9OI208GCb/arcgis/rest/services/Spilhaus_UV_ocean_currents/ImageServer
...
const map = new EsriMap({
  layers: [tileLayer, temperatureLayer, currentsLayer, flowLayer]//, windLayer]
});
